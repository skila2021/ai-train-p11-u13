...
import org.xingyu.ccq.domain.Users;
import org.xingyu.ccq.service.IUsersService;
...
public class UsersController extends BaseController
{
     ...
     */
    @PreAuthorize("@ss.hasPermi('ccq:users:list')")
    @GetMapping("/list")
     ...
     */
    @PreAuthorize("@ss.hasPermi('ccq:users:export')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('ccq:users:query')")
    @GetMapping(value = "/{id}")
     ...
     */
    @PreAuthorize("@ss.hasPermi('ccq:users:add')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('ccq:users:edit')")
     ...
     */
    @PreAuthorize("@ss.hasPermi('ccq:users:remove')")
