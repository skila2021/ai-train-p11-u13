  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['ccq:profiles:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['ccq:profiles:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="profilesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['ccq:profiles:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['ccq:profiles:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { listProfiles, getProfiles, delProfiles, addProfiles, updateProfiles } from "@/api/ccq/profiles"
...
function handleExport() {
  proxy.download('ccq/profiles/export', {
    ...queryParams.value
